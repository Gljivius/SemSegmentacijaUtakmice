...
DATA_DIR = r'C:\Users\6lj1v\Desktop\SemSegmentacija'    #unesite ovdje svoj put do datoteka
TRAINER = None
...
class Application(Frame):
    def __init__(self, master):
        ...
        self.parent = master
        # paths to pictures
        self.pathDefaultPictures = os.path.join(DATA_DIR, r"Slike\SlikeZaUcenje\\")
        self.pathProcessedPictures = os.path.join(DATA_DIR, r"Slike\IzlazneSlike\\")
        self.pathLabelPictures = os.path.join(DATA_DIR, r"Slike\SlikeOznaka\\")
        self.pathSegmentation = os.path.join(DATA_DIR, r"Slike\\")
